...
def github_login(request):
    ...
    redirect_uri = "http://airbnb-clone.eba-wftkkpye.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback/"
    # scope는 허용 범위
    return redirect(
...
def kakao_login(request):
    ...
    redirect_uri = "http://airbnb-clone.eba-wftkkpye.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback/"
    return redirect(
